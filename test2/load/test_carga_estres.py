...
def test_compras_100():
    ...
    ejecutar_prueba_con_metrica(emails, 10, simular_compra, "Compras Concurrentes - 50")

def test_compras_1000():
    emails = ["denilson0@gmail.com"] * 1000
    ejecutar_prueba_con_metrica(emails, 20, simular_compra, "Compras Concurrentes - 100")
...
def test_logins_100():
    emails = ["denilson0@gmail.com"] * 100
    ejecutar_prueba_con_metrica(emails, 10, simular_login, "Logins Concurrentes - 50")

def test_logins_1000():
    emails = ["denilson0@gmail.com"] * 1000
    ejecutar_prueba_con_metrica(emails, 20, simular_login, "Logins Concurrentes - 100")
...
def test_pdfs_100():
    compra_ids = [1] * 100
    ejecutar_prueba_con_metrica(compra_ids, 10, simular_generacion_pdf, "PDFs Concurrentes - 50")

def test_pdfs_1000():
    compra_ids = [1] * 1000
    ejecutar_prueba_con_metrica(compra_ids, 20, simular_generacion_pdf, "PDFs Concurrentes - 100")
